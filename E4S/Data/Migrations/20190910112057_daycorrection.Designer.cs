...
namespace E4S.Data.Migrations
{
    ...
    [Migration("20190910112057_daycorrection")]
    partial class daycorrection
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BizManager.Models.WragbyAdmin.BatchLK", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BizManager.Models.WragbyAdmin.License", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("BatchLKId");
                    ...
                    b.HasIndex("BatchLKId");

                    b.ToTable("Licenses");
                });

            modelBuilder.Entity("BizManager.Models.WragbyAdmin.LicenseType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BizManager.Models.WragbyAdmin.BatchLK", b =>
                {
                    b.HasOne("BizManager.Models.WragbyAdmin.LicenseType", "LicenseType")
                        .WithMany()
            ...
            modelBuilder.Entity("BizManager.Models.WragbyAdmin.License", b =>
                {
                    b.HasOne("BizManager.Models.WragbyAdmin.BatchLK", "BatchLK")
                        .WithMany()
                        .HasForeignKey("BatchLKId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
